...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO fever (fever_name, fever_price, fever_image) VALUES (%s, %s, %s)",
...
<head>
    <meta charset="UTF-8">
    <title>Insert New Colds Medicine</title>
    <style>
        body {
...
<body>
    <table border="2">
        <tr>
            <th>INSERT NEW COLDS MEDICINE</th>
        </tr>
        <tr>
            <td>
