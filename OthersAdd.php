...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO others (others_name, others_price, other_pic) VALUES (%s, %s, %s)",
...
<head>
    <meta charset="utf-8">
    <title>Insert New Others Medicine</title>
    <style>
        body {
...
<body>
    <table border="2">
        <tr>
            <th>INSERT NEW OTHERS MEDICINE</th>
        </tr>
        <tr>
            <td>
